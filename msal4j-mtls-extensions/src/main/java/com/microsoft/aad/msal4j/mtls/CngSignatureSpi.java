...
abstract class CngSignatureSpi extends SignatureSpi {
    ...
    /** SHA-256 with RSA-PSS and matching MGF1 digest/salt defaults. */
    public static class Sha256WithRsaPss extends CngSignatureSpi {
        public Sha256WithRsaPss() { super("SHA-256", "SHA256", true, 32); }
    }

    /** SHA-384 with RSA-PSS and matching MGF1 digest/salt defaults. */
    public static class Sha384WithRsaPss extends CngSignatureSpi {
        public Sha384WithRsaPss() { super("SHA-384", "SHA384", true, 48); }
    }

    /** SHA-512 with RSA-PSS and matching MGF1 digest/salt defaults. */
    public static class Sha512WithRsaPss extends CngSignatureSpi {
        public Sha512WithRsaPss() { super("SHA-512", "SHA512", true, 64); }
    }
