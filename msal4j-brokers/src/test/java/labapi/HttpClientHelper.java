...
class HttpClientHelper {
    static String sendRequestToLab(String url, Map<String, String> queryMap, String accessToken)
            throws IOException {
    ...
    private static URL buildUrl(String url, Map<String, String> queryMap)
            throws MalformedURLException, UnsupportedOperationException {
        String queryParameters;
        queryParameters = queryMap.entrySet()
                                  .stream()
